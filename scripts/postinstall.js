...
const supportedDistros = ["ubuntu", "debian", "pve", "raspbian", "pop", "zorin", "linuxmint", "elementary", "pureos", "kali"];

if (!distro || !supportedDistros.some((name) => distro.includes(name))) {
  console.log("Skipping playwright installation on unsupported platform:", platform, rel, distro || "unknown distro");
  process.exit(0);
}
